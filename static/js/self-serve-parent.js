...
(function() {
  function onLoad() {
    if (typeof(jQuery) === 'undefined') {
      // jQuery isn't loaded yet.
      // HACK: wait a bit and try again later.
    ...
    //# sourceMappingURL=../vendor/iframeResizer/iframeResizer.map

    jQuery('iframe').iFrameResize({
      enablePublicMethods: true,
      messageCallback: function(event) {
        var message = JSON.parse(event.message);
        if (message.action === 'get-top') {
  ...
  // From: http://stackoverflow.com/a/559161/729729
